...
export async function getTweenerUrl(nexus:string): Promise<string> {
...
export async function authenticate(nexus:string, passport:string, password:string, challenge:string): Promise<string> {
